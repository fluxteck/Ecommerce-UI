            ...
            <div className="lg:col-span-8 md:col-span-6">
              <div className="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                ...
                <div className="p-6">
                  ...
                  <p className="text-slate-400 italic border-x-4 border-gray-800 rounded-ss-xl rounded-ee-xl mt-3 p-3">
            ...
            <div className="lg:col-span-4 md:col-span-6">
              <div className="sticky top-20">
                ...
                <div className="text-center mt-8">
                  ...
                  <Link
                    href=""
                    className="text-lg font-medium hover:text-gray-800 transition-all duration-500 ease-in-out h5"
                  >
                    Cristina Romsey
                  </Link>
                  ...
                  {social.map((item, index) => {
                    ...
                    return (
                      <li className="inline" key={index}>
                        <Link
                          href=""
                          className="size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-gray-800 hover:text-white hover:bg-gray-800"
                        >
              ...
              return (
                <div className="group relative overflow-hidden" key={index}>
                  ...
                  <div className="mt-6">
                    ...
                    <Link
                      href="/blog-detail"
                      className="title text-lg font-semibold hover:text-gray-800 duration-500 ease-in-out"
                    >
                      {item.title}
                    </Link>
                    ...
                    <div className="mt-3">
                      <span className="text-slate-400">
                        ...
                        <Link
                          href=""
                          className="text-slate-900 dark:text-white hover:text-gray-800 dark:hover:text-gray-800 font-medium"
                        >
                          MA Mark
                        </Link>
                      </span>
