        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            <h3 className="text-4xl leading-normal tracking-wider font-semibold text-white">
              Tips For Wearing Loose T-shirts
            </h3>
            ...
            <ul className="list-none mt-6">
              <li className="inline-block text-white/50 mx-5">
                ...
                <span className="block">MA Mark</span>
              </li>
              <li className="inline-block text-white/50 mx-5">
                {" "}
                <span className="text-white block">Date :</span>{" "}
                <span className="block">19th June, 2025</span>
              </li>
              <li className="inline-block text-white/50 mx-5">
                {" "}
            ...
            <div className="lg:col-span-8 md:col-span-6">
              <div className="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                ...
                <div className="p-6">
                  ...
                  <p className="text-slate-400 italic border-x-4 border-red-900 rounded-ss-xl rounded-ee-xl mt-3 p-3">
              ...
              <div className="p-6 rounded-md shadow dark:shadow-gray-800 mt-8">
                ...
                <form className="mt-8">
                  ...
                  <button
                    ...
                    id="submit"
                    name="send"
                    className="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-red-900 text-white rounded-md w-full"
                  >
                    Send Message
                  </button>
                </form>
            ...
            <div className="lg:col-span-4 md:col-span-6">
              <div className="sticky top-20">
                ...
                <div className="text-center mt-8">
                  ...
                  <Link
                    href=""
                    className="text-lg font-medium hover:text-red-900 transition-all duration-500 ease-in-out h5"
                  >
                    Cristina Romsey
                  </Link>
                  ...
                  {social.map((item, index) => {
                    ...
                    return (
                      <li className="inline" key={index}>
                        <Link
                          href=""
                          className="size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-red-900 hover:text-white hover:bg-red-900"
                        >
              ...
              return (
                <div className="group relative overflow-hidden" key={index}>
                  ...
                  <div className="mt-6">
                    ...
                    <Link
                      href="/blog-detail"
                      className="title text-lg font-semibold hover:text-red-900 duration-500 ease-in-out"
                    >
                      {item.title}
                    </Link>
                    ...
                    <div className="mt-3">
                      <span className="text-slate-400">
                        ...
                        <Link
                          href=""
                          className="text-slate-900 dark:text-white hover:text-red-900 dark:hover:text-red-900 font-medium"
                        >
                          MA Mark
                        </Link>
                      </span>
