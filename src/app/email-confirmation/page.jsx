                ...
                <tbody>
                    ...
                    <tr>
                        <td style={{padding: '16px 16px 0', color: '#161c2d'}}>
                            ...
                            <p style={{marginBottom: '0', color: '#94a3b8'}}>Thanks for creating an MA Mark account. To continue, please confirm your email address by clicking the button below :</p>
                        </td>
                    </tr>
    
                    <tr>
                        <td style={{padding: '16px 16px 0'}}>
                            <Link href="#" style={{padding: '8px 20px', outline: 'none', textDecoration: 'none', fontSize: '15px', display: 'inline-block', letterSpacing: '0.5px', transition: 'all 0.3s', fontWeight: '500', borderRadius: '6px', backgroundColor:' #f97316', border:' 1px solid #f97316', color: '#ffffff'}}>Confirm Email Address</Link>
                        </td>
                    </tr>
