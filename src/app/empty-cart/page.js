            ...
            <div className="flex flex-col min-h-screen justify-center md:px-10 py-10 px-4">
              ...
              <div className="title-heading text-center my-auto">
                ...
                <div className="mt-4">
                  <Link
                    href="/"
                    className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-gray-800 hover:bg-gray-800 border-gray-800 hover:border-gray-800 text-white rounded-md"
                  >
                    Back to Home
                  </Link>
                </div>
