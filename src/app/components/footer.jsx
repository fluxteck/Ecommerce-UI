                        ...
                        <div className="py-[60px] px-0">
                            <div className="grid md:grid-cols-12 grid-cols-1 gap-6">
                                ...
                                <div className="lg:col-span-6 md:col-span-12">
                                    {/* <h5 className="tracking-[1px] text-gray-100 font-semibold">Shopping</h5> */}
                                ...
                                <div className="lg:col-span-3 md:col-span-4">
                                    ...
                                    <p className="mt-6">Sign up and receive the latest tips & deals.</p>
                                    <form>
                                        <div className="grid grid-cols-1">
                                            <div className="my-3">
                                                <label className="form-label">Enter your email <span className="text-red-600">*</span></label>
                ...
                <div className="container relative text-center">
                    <div className="grid md:grid-cols-2 items-center">
                        <div className="md:text-start text-center">
                            <p className="mb-0">© {new Date().getFullYear()} MA Mark. Design & Develop with <i className="mdi mdi-heart text-red-600"></i> by <Link href="https://shreethemes.in/" target="_blank" className="text-reset">Fluxteck</Link>.</p>
                        </div>
