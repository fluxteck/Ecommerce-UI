    ...
    <div className="grid md:grid-cols-12 grid-cols-1 mt-6 gap-6">
      ...
      <div className="lg:col-span-9 md:col-span-7">
        ...
        >
          {activeTab === 1 && (
            <div>
              <div>{<RenderSafeHTML html={product.description} />}</div>
            </div>
          )}
          {/* {activeTab === 2 && (
            <div>
                ...
                return (
                  <div className="mt-8 first:mt-0" key={index}>
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        href=""
                        className="text-slate-400 hover:text-black duration-500 ms-5"
                      >
              ...
              <div className="p-6 rounded-md shadow dark:shadow-gray-800 mt-8">
                ...
                <form className="mt-8">
                  ...
                  <button
                    ...
                    id="submit"
                    name="send"
                    className="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center bg-black text-white rounded-md w-full"
                  >
                    Send Message
                  </button>
                </form>
