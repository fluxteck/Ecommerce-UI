...
export default function ProductDetailTwo(){
    return(
        ...
        <section className="relative table w-full pt-20 bg-gray-50 dark:bg-slate-800">
            <div className="container relative">
                ...
                <div className="relative mt-3">
                    <ul className="tracking-[0.5px] mb-0 inline-block">
                        <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-black"><Link href="/">Cartzio</Link></li>
                        ...
                        <li className="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-black"><Link href="/shop-grid">Store</Link></li>
                        <li className="inline-block text-base text-slate-950 dark:text-white mx-0.5 ltr:rotate-0 rtl:rotate-180"><i className="mdi mdi-chevron-right"></i></li>
                        <li className="inline-block uppercase text-[13px] font-bold text-black" aria-current="page">Mens Brown Jecket</li>
                    </ul>
                </div>
            </div>
        </section>
