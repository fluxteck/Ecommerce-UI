            ...
            <tr>
              ...
              >
                <Image
                  ...
                  alt=""
                />
                <h1 style={{ fontWeight: "600", margin: "16px 0 0" }}>
                  Thank you!
                </h1>
              </td>
            </tr>
            ...
            <tr>
              <td style={{ padding: "16px 16px 0", color: "#161c2d" }}>
                ...
                <p style={{ marginBottom: "0", color: " #94a3b8" }}>
                  Thank you for your order success. Payment is proceed
                  successfull and your order is on the way. Please check your
                  order via{" "}
                  <span style={{ fontWeight: "500", color: "#161c2d" }}>
                    Transaction ID: 151448HJG5JTUYV5
                  </span>
                </p>
              </td>
            </tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style={{ padding: "16px" }}>
                        <span style={{ display: "flex", alignItems: "center" }}>
                          <Image
                            src="/images/shop/fashion-shoes-sneaker.jpg"
                            width={48}
                            height={62}
                            style={{
                              width: "48px",
                    ...
                    <tr>
                      <td style={{ padding: "16px" }}>
                        <span style={{ display: "flex", alignItems: "center" }}>
                          <Image
                            src="/images/shop/ladies-skirt-pair.jpg"
                            width={48}
                            height={62}
                            style={{
                              width: "48px",
                    ...
                    <tr>
                      <td style={{ textAlign: "center" }}>
                        <p style={{ margin: "4px 0 10px" }}>
                          © {new Date().getFullYear()} MA Mark. Designed by{" "}
                          <Link
