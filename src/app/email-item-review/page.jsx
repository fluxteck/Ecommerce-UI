                ...
                <tbody>
                    ...
                    <tr>
                        <td style={{padding: '16px', color: '#94a3b8'}}>
                            <label htmlFor="review" style={{color: '#161c2d', fontWeight: '500'}}>Write your rating:</label>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style={{textAlign: 'center'}}>
                                            <p style={{margin: '4px 0 10px'}}>© {new Date().getFullYear()} MA Mark. Designed by <Link href="https://fluxteck.com/" target="_blank" style={{textDecoration: 'none', color: '#fff'}}>Shreethemes</Link>.</p>
                                        </td>
                                    </tr>
