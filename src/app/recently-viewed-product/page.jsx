        ...
        <section className="relative table w-full py-20 lg:py-24 bg-gray-50 dark:bg-slate-800">
            ...
            <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
                <ul className="tracking-[0.5px] mb-0 inline-block">
                    ...
                    <li className="inline-block uppercase text-[13px] font-bold text-gray-800" aria-current="page">Recently Viewed Products</li>
                </ul>
            </div>
        </section>
            ...
            <div className="container relative">
                <div className="grid grid-cols-1">
                    <div className="rounded p-6 shadow dark:shadow-gray-800">
                        <p className="text-slate-400">No products were added to the compare page. <Link href="/shop-grid" className="font-medium text-gray-800">Back to shopping</Link></p>
                    </div>
                </div>
            </div>
        </section>
