...
export default function Home() {
    return (
        <>
            ...
            <section className="relative md:flex table w-full items-center py-2 md:py-46 md:bg-top mt-5 bg-center bg-no-repeat md:bg-cover bg-contain" style={{ backgroundImage: "url('https://yxdyohefwpubwydtctbs.supabase.co/storage/v1/object/public/products/Home%20Page/Main%20Banner.png')" }}>
